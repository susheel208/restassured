...
public class TC005_GET_Request_Authorization {
 ...
 
 {
  ...
  System.out.println(jsonpath.get("City"));                    // to extrext the values
  System.out.println(jsonpath.get("Temeperature"));
  System.out.println(jsonpath.get("Humidity"));
  System.out.println(jsonpath.get("City"));                    // theses are actual values
  
//============> Asserting the values of the keys, with>============
